...
with open('/Users/wangtaiyi/Documents/Graduate/Cambridge/Research/RL/Learning_Index_Selection/index_Code/Multi-level_Index/Query_level_index_tuning/conf/dqn.json', 'r') as f:
    config = json.load(f)
